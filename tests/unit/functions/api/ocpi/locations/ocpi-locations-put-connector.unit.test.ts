...
const MOCK_S3_KEY =
  'connector/year=2025/month=01/day=01/country=DE/party=EMS/location_id=LOC001/evse_uid=EVSE001/connector_id=1/PUT_20250101T000000000Z.json';
...
describe('ocpi-locations-put-connector handler', () => {
  ...
  describe('happy path', () => {
    ...
    it('publishes the SQS event after writing to S3', async () => {
      ...
      const sqsCallOrder =
        mockPublishIngestionEvent.mock.invocationCallOrder[0];
